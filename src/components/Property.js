...
function Property(props) {
    ...
    const selectedProperty = props.items.find(item => item.id === Number(params.id))
    return (
            ...
            <div className="property__main">
                <div className="property__banner">
                    <div className="property__info">
                        ...
                        <nav className="property__subNav">
                            <Link className="property__des" to={`${routeMatch.url}/description`}>Description</Link>
                            <Link className="property__photo" to={`${routeMatch.url}/photos`}>Photos</Link>
                            <Link className="property__fp" to={`${routeMatch.url}/floorplan`}>Floorplan</Link>
                            <Link className="property__map" to={`${routeMatch.url}/map`}>Map</Link>
                        </nav>
                    </div>
